...
import '../Styles/VerAdministrargrados.css';
    ...
    const continuar = () =>{
        swal({
          ...
          icon: "success",                        
            ...
            window.location = "/VerAdministrarCursos";            
        });
    }
...
class VerAdministrarGrados extends React.Component{
    ...
    render() {
        return (
            ...
            <div className="columns centralGrado">

              <div className="column"></div>

                <div className="column is-two-thirds" >

                    <div className="cardGrados">
                    <center>

                        <h1 className="adminExpoletraGrado"> ¡GRADES🎓! </h1>   

                        <br></br>

                        <div className="form-group">                                
                            <input autoFocus required placeholder="Search By Name" type="text" id="busqueda" className="FondoInputGrados" onChange={this.manejarCambio} value={this.state.data.busqueda}>
                            </input>
                        </div>
                        ...
                        <div className="form-group">                                
                            <input autoFocus required placeholder="Write the ID: " type="number" id="id" className="FondoInputGrados" onChange={this.manejarCambio} value={this.state.data.id}>
                            </input>
                        </div>
...
export default VerAdministrarGrados;