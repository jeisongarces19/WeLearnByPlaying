...
import '../Styles/Administrarkit.css';
...
function ObservarDirecto(props) { 
    ...
    const continuar = () =>{
        swal({
          ...
          text: "¡Now you can access this kit!"+props+ "",
          icon: "success",                        
        }).then(function() {            
...
class AdministrarKit extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
          data: {
    ...
    async componentDidMount1() {
        ...
        var respuesta = await fetch(`https://fun-english-cali.herokuapp.com/Lesson/Search/lesson_type_id/`+2, 
        {
            method: "GET",    
        });            
    ...
    async componentDidMount2() {
        ...
        if (this.state.data.busqueda==="") {
            ...
            var respuesta2 = await fetch(`https://fun-english-cali.herokuapp.com/Lesson/Search/lesson_type_id/`+2, 
            {
                method: "GET",    
            });            
                    ...
                    <center>
                        ...
                        <div className="form-group">
                            <button className="button is-primary mt-2">
                                <a rel="noreferrer" href="/CrearKits">Create Kit</a>
                            </button>
                        </div>
    ...
    async eliminarExposicion(evento){
        ...
        const detener = () =>{
            swal({
              title: "¡Error!",
              text: "¡There is no Kit ! You are not the owner!",
              icon: "error",
              timer: 6000,
            });
        }    
    ...
    async observarExposicion(evento){
        ...
        const continuar = () =>{
            swal({
                title: "!Congratulations!",
                text: "¡Now you can access this Kit !",
                icon: "success",                        
            }).then(function() {
                    
                    window.location = "/AdmnistrarKit";
